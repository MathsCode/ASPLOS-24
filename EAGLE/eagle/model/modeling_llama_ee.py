    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if not init and idx <= len(self.layers):
                ...
                hidden_states_tmp = self.norm(hidden_states[:,list(draft_tokens_list.keys())])
                ...
                draft_logits_new = draft_logits[:,row_indices,indices]
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            draft_token_index = draft_token_index,
            lm_head = lm_head,
