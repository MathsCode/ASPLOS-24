...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        self.predictors = [torch.load('/home/xujiaming/xujiaming/train_machine/xjm/ASPLOS-24/results/model'+str(layer_idx)+'.pth').to(torch.float16) for layer_idx in range(config.num_hidden_layers)]
