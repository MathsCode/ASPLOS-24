...
class Model(nn.Module):
    ...
    def topK_genrate(self, hidden_states, input_ids, head, logits_processor):
        ...
        # [xjm:] Step1: [0]-the first hop candidates [1]-all the candidates
        draft_tokens_info = {i:[set(),set()] for i in range(total_tokens+1)}
        for i in range(total_tokens + 1):
            # if i < total_tokens:
            #     draft_tokens_info[mask_index_list[i]][0].add(i+1)
            if i not in noleaf_index:
                ...
                for j in reversed(range(depth + 1)):
                    ...
                    if j > 0:
                        draft_tokens_info[mask_index_list[cid - 1]][0].add(cid)
                        draft_tokens_info[mask_index_list[cid - 1]][1].add(cid)
                        draft_tokens_info[mask_index_list[cid - 1]][1].update(draft_tokens_info[cid][1])
        ...
        return draft_tokens, retrieve_indices, tree_mask, tree_position_ids, draft_tokens_info
