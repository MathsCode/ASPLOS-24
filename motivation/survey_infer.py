from Spec_model import EEModel
import torch
...
import json
from model_llama_survey import MLP
...
for i in trange(10,len(question_list)):
    ...
    input_ids = torch.as_tensor(input_ids).cuda()
    draft_token_prob_curve_set = {}
    output_ids=model(input_ids,max_new_tokens=256,exit_layer_id_list=exit_layer_id_list,draft_token_prob_curve_set=draft_token_prob_curve_set)
    draw_curve(i,draft_token_prob_curve_set)
